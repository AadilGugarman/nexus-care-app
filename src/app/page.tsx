    ...
    <main className="min-h-screen relative">
      ...
      <div className="mx-auto max-w-xl px-4 pt-4 safe-top" style={{ paddingBottom: 120 }}>
        ...
        <div key={activeTab} className="animate-fade-in">
          ...
          {activeTab === 'locations' && <Locations onEditDoctor={handleEditDoctor} />}
          {activeTab === 'days' && <Days onEditDoctor={handleEditDoctor} />}
      ...
      <DoctorFormDialog
        open={doctorFormOpen}
        onOpenChange={setDoctorFormOpen}
        initial={editingDoctor}
        locations={locations}
        onSubmit={handleDoctorSubmit}
        onDelete={editingDoctor ? handleDoctorDelete : undefined}
      />
