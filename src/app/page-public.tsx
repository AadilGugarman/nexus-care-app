...
import { Search, MapPin, Phone, Users, Building2, Stethoscope } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="bg-gradient-to-b from-slate-800 to-slate-900 px-4 py-8">
        <div className="max-w-lg mx-auto text-center">
          ...
          <Link
            href="/login"
            className="block w-full py-3 bg-slate-800 hover:bg-slate-700 active:bg-slate-600 text-slate-300 rounded-lg font-medium transition-colors border border-slate-700"
          >
            Sign In
          </Link>
        </div>
      ...
      {/* Network Stats - Compact 3-Column */}
...
function StatChip({ 
  ...
  return (
    <div className="bg-slate-800 rounded-lg p-3 text-center border border-slate-700">
      <Icon className="w-5 h-5 mx-auto mb-1.5 text-blue-400" />
...
function FeatureChip({ 
  ...
  return (
    <div className="inline-flex items-center gap-2 px-3 py-2 bg-slate-800 rounded-lg border border-slate-700">
